...
protected:
    ...
    FLYCOLOR m_cDiffuse;        // Light color.
...
public:
    ...
    // Generate the lighting data.
    void GenerateLightData(void);
    ...
    const FLYCOLOR& GetDiffuseColor(void) const { return m_cDiffuse; }
    ...
    void SetLightColor( const FLYCOLOR& color ) { m_cDiffuse = color; }
