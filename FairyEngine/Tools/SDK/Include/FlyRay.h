...
public:
    ...
    bool Intersects(const FlyVector &vc0, const FlyVector &vc1,
                    const FlyVector &vc2, bool bCull,
                    float fL, float *t) const;
    bool Intersects(const FlyPlane &plane, bool bCull,
                    float *t, FlyVector *vcHit) const;       
    bool Intersects(const FlyPlane &plane, bool bCull,
                    float fL, float *t, FlyVector *vcHit) const;
    bool Intersects(const FlyAabb &aabb, float *t) const;
    bool Intersects(const FlyAabb &aabb, float fL, float *t) const;
    bool Intersects(const FlyObb &obb, float *t) const;
    bool Intersects(const FlyObb &obb, float fL, float *t) const;
};
