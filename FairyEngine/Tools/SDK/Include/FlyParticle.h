//------------------------------------------------------------------------
// Name: FlyParticle.h
// Desc: This file define a class to store the particle template data.
//       Particles change their attributes during the life according to 
//       the template.
// ----------------------------------------------------------------------
...
public:
    ...
    const char* GetTexName(void);
    int GetNumAnims(void);
    int GetNumFrames(void);
    float GetGravity(void);
    float GetResistValue(void);
    float GetMinSpeedResist(void);
    bool IsUseResist(void);
