...
//#define _FLYMATH_DYN_LIB

#ifdef _FLYMATH_DYN_LIB
#define _MATH_EXPORT __declspec(dllexport)
#else
#define _MATH_EXPORT __declspec(dllimport)
#endif

// Define some constant variables for the library.
...
#define FLY_INSIDE      6
#define FLY_OUTSIDE     7
#define FLY_INTERSECT   8
