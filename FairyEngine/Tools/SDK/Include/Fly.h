...
#ifdef _FLY_DYN_LIB
#define _FLY_EXPORT __declspec(dllexport)
#else
#define _FLY_EXPORT __declspec(dllimport)
#endif
...
#define FLY_INVALIDMODULE       0x82000015L
#define FLY_RESOURCEEXISTED     0x82000016L
...
#define DWORD2FLOAT( dw )       (float)( *((float*)(&dw)) )
